...
function get_book_issue_limit_per_staff($connect)
{
	$output = '';
	$query = "
	SELECT library_total_book_issue_per_staff FROM lms_setting 
	LIMIT 1
	";
	$result = $connect->query($query);
	foreach($result as $row)
	{
		$output = $row["library_total_book_issue_per_staff"];
	}
	return $output;
}
...
function get_total_book_issue_day_staff($connect)
{
	$output = 0;

	$query = "
	SELECT library_total_book_issue_staff FROM lms_setting 
	LIMIT 1
	";
	...
	foreach($result as $row)
	{
		$output = $row["library_total_book_issue_staff"];
	}
	return $output;
}
